...
from core import SceneManager, assets
...
class App:
    ...
    def window_to_canvas_pos(
        self, window_pos: tuple[int, int]
    ) -> tuple[int, int]:
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if (
                    ...
                    and event.key in self.global_key_actions
                ):
                    self.global_key_actions[event.key]()

                mouse_canvas_pos = self.window_to_canvas_pos(
